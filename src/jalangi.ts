...
// ADAPTED FROM https://raw.githubusercontent.com/Samsung/jalangi2/master/src/js/runtime/analysisCallbackTemplate.js
...
export class JalangiAnalysis {
	 ...
	 *
	 */
	literal(iid: number, val: any, hasGetterSetter: boolean): { result: any; } | undefined {
		return { result: val };
	};
	 ...
	 *
	 */
	forinObjectfunction(iid: number, val: any): { result: any; } | undefined {
		return { result: val };
	};
	 ...
	 *
	 */
	declare(iid: number, name: string, val: any, isArgument: boolean, argumentIndex: number, isCatchParam: boolean): { result: any; } | undefined {
		return { result: val };
	};
	 ...
	 *
	 */
	getFieldPre(iid: number, base: any, offset: string | any, isComputed: boolean, isOpAssign: boolean, isMethodCall: boolean): { base: any; offset: any; skip: boolean; } | undefined {
	 ...
	 */
	putFieldPre(iid: number, base: any, offset: any, val: any, isComputed: boolean, isOpAssign: boolean): { base: any; offset: any; val: any; skip: boolean; } | undefined {
	 ...
	 * replaced with the value stored in the <tt>result</tt> property of the object.
	 */
	putField(iid: number, base: any, offset: any, val: any, isComputed: boolean, isOpAssign: boolean): { result: any; } | undefined {
		return { result: val };
	};
	 ...
	 * replaced with the value stored in the <tt>result</tt> property of the object.
	 */
	read(iid: number, name: string, val: any, isGlobal: boolean, isScriptLocal: boolean): { result: any; } | undefined {
		return { result: val };
	};
	 ...
	 * replaced with the value stored in the <tt>result</tt> property of the object.
	 */
	write(iid: number, name: string, val: any, lhs: any, isGlobal: boolean, isScriptLocal: boolean): { result: any; } | undefined {
		return { result: val };
	};
	 ...
	 * replaced with the value stored in the <tt>result</tt> property of the object.
	 */
	_return(iid: number, val: any): { result: any; } | undefined {
		return { result: val };
	};
	 ...
	 * replaced with the value stored in the <tt>result</tt> property of the object.
	 */
	_throw(iid: number, val: any): { result: any; } | undefined {
		return { result: val };
	};
	 ...
	 * replaced with the value stored in the <tt>result</tt> property of the object.
	 */
	_with(iid: number, val: any): { result: any; } | undefined {
		return { result: val };
	};
	 ...
	 * symbolic execution.
	 */
	functionExit(iid: number, returnVal: any, wrappedExceptionVal: { exception: any; } | undefined): { returnVal: any; wrappedExceptionVal: any; isBacktrack: boolean; } {
	 ...
	 * symbolic execution.
	 */
	scriptExit(iid: number, wrappedExceptionVal: { exception: any; } | undefined): { wrappedExceptionVal: any; isBacktrack: boolean; } {
	 ...
	 */
	binaryPre(iid: number, op: string, left: any, right: any, isOpAssign: boolean, isSwitchCaseComparison: boolean, isComputed: boolean): { op: string; left: any; right: any; skip: boolean; } | undefined {
	 ...
	 * replaced with the value stored in the <tt>result</tt> property of the object.
	 */
	binary(iid: number, op: string, left: any, right: any, result: any, isOpAssign: boolean, isSwitchCaseComparison: boolean, isComputed: boolean): { result: any; } | undefined {
		return { result: result };
	};
	 ...
	 */
	unaryPre(iid: number, op: string, left: any): { op: any; left: any; skip: boolean; } | undefined {
	 ...
	 *
	 */
	unary(iid: number, op: string, left: any, result: any): { result: any; } | undefined {
		return { result: result };
	};
	 ...
	 * replaced with the value stored in the <tt>result</tt> property of the object.
	 */
	conditional(iid: number, result: any): { result: any; } | undefined {
		return { result: result };
	};
	 ...
	 */
	instrumentCodePre(iid: number, code: any, isDirect: boolean): { code: any; skip: boolean; } {
	 ...
	 * replaced with the value stored in the <tt>result</tt> property of the object.
	 */
	instrumentCode(iid: number, newCode: any, newAst: object, isDirect: boolean): { result: any; } | undefined {
